...
def net(image, type=0):
    ...
    resi1 = _residual_block(conv3, 3)
    resi2 = _residual_block(resi1, 3)
    resi3 = _residual_block(resi2, 3)
    resi4 = _residual_block(resi3, 3)
    resi5 = _residual_block(resi4, 3)
    convt1 = _conv_tranpose_layer(resi5, 64, 3, 2)
    convt2 = _conv_tranpose_layer(convt1, 32, 3, 2)
    conv4 = _conv_layer(convt2, 3, 9, 1)
...
def _residual_block(net, filter_size=3, type=0):
    ...
    tmp = _conv_layer(net, 128, filter_size, 1, relu=True, type=type)
    tmp = _conv_layer(tmp, 128, filter_size, 1, relu=False, type=type)                #F(x)
